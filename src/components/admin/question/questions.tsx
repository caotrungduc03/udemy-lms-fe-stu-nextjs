...
export default function Question() {
   const data = [
    {
        questionId: '1',
        questionType: 'Trả lời nhanh',
        questionTitle: 'Ai là người lên mặt trăng đầu tiên',
        answser: 'a',
        correctAnswer:'a',
        maxPoint:'100',
    }
            ...
            <tbody>
              ...
              {data.map((v) => (
                ...
                >
                  ...
                  <td className="px-6 py-4">{v.questionType}</td>
                  <td className="px-6 py-4">{v.questionTitle}</td>
                  <td className="px-6 py-4">{v.answser}</td>
                  <td className="px-6 py-4">{v.correctAnswer}</td>
                  <td className="px-6 py-4">{v.maxPoint}</td>
                  <td>
                    <div className="m-px">
