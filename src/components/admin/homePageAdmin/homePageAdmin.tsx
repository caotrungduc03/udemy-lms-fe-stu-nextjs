import { Sidebar } from "../adminPage/sidebar/index";
import { Header } from "../adminPage/header/index";

export const HomePageAdmin = () => {
  const data = [
    {name: 'Nguyễn Ngọc Uớc',
      email: 'nguyenuoc.work@gmail.com',
      phone: '0938 960 697',
      status:'True',
    },
  ]
  ...
  return (
    <div className="relative overflow-x-auto">
      <table className="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
        ...
        {data.map((v) => (
            <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700" key={v.name}>
