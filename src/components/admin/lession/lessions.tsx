...
export const Lession = () => {
  const data = [
    {
      lessionName: "Bài 1: Làm quen với lập trình hướng đối tượng",
      lessionDuration:"20:15",
      content: "Chương I: Lập Trình Hướng Đối Tượng ",
      lessionDescription: "Làm quen với lập trình hướng đối tượng",
    },
  ];
        ...
        <tbody>
          ...
          {data.map((v) => (
            ...
            >
              ...
              <td className="px-6 py-4">{v.lessionDuration}</td>
              <td className="px-6 py-4">{v.content}</td>
              <td className="px-6 py-4">{v.lessionDescription}</td>
              <td>
                <div className="m-px">
