    ...
    <div className=' w-full py-14 flex items-center h-screen'>
            <div className=' w-full flex flex-col justify-center items-center'>
                <form className='login flex flex-col px-10 bg-slate-200 py-10 w-4/12 rounded-lg '>
                    ...
                    <button type="submit" className='font-bold rounded-md m-1 p-3 font-RobotoMono border-none my-5 bg-slate-500 hover:transition-all hover:bg-[#7dd3fc]'>Login</button>
