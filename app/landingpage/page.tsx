...
const comments = [
  {
    comment: "I am proud to say that after a few months of taking this course...I passed my exam and am now an AWS Certified Cloud Practitioner! This content was exactly what the CCP exam covered.",
    name: "Will Smith",
  ...
  return (
    <>
      <div className="relative w-full" style={{ height: 'auto' }}>
        <div className="mx-20 bg-cover bg-center bg-gray-100 flex" style={{ backgroundImage: 'url(./clock-landingpage.jpg)', width: '90%', height: '90%' }}>
          <div className="z-10 items-left justify-center text-black ml-20 mt-20 mb-30 p-30">
            <div className="bg-white shadow-lg border border-gray-100 mb-20 pr-20" style={{ width: '70%' }}>
              <h1 className="text-4xl font-udemy-sans font-bold ml-5 mt-5">New to Udemy?</h1>
              <h1 className="text-4xl font-bold pt-5 ml-5">Lucky you</h1>
              <p className="text-md ml-5 pt-5 mb-10">Courses start at 299,000vnd. Get your new-student offer before it expires.</p>
            </div>
          </div>
      ...
      <div className="mt-10 text-center bg-gray-100 content-around">
        <div className="mt-16 text-gray-500 mb-5">Trusted by over 15,000 companies and millions of learners around the world</div>
            ...
            >
              {courses.map((object, index) => (
                <SwiperSlide key={index} className="mb-10">
                  <div>
                <Image src={object.imageSrc} alt="card" className="border border-gray-200 mt-2"/>
                <p className="font-bold text-sm">{object.title}</p>
                <p className="text-gray-600 text-xs">{object.author}</p>
                <div className="flex">
                ...
                <span className="font-bold text-md">299,000vnd</span>
              </div>
                </SwiperSlide>
              ))}
            </Swiper>
            ...
            {comments.map((object, index) => (
              <SwiperSlide key={index} className="mb-10 bg-white">
                <div className="border border-gray-200 p-10">
                  ...
                  <p className="border-b border-gray-200 font-bold text-sm py-5">{object.name}</p>
                  <div className="flex pt-5 ">
                    <FaPlayCircle size={40} color="purpil"/>
                    <div className="ml-2 font-bold text-[#5022c3]">{object.video}</div>
                  </div>
                </div>
              </SwiperSlide>
            ))}
      ...
      <div className="mt-10 bg-gray-100 content-around">
        <div className="ml-20 mb-10">
          ...
          <div className="grid grid-cols-4 gap-y-5">
            ...
            <span className="text-purple-900 font-bold text-xs underline">Python</span>
            <span className="text-purple-900 font-bold text-xs underline">Financial Analysis</span>
            <span className="text-purple-900 font-bold text-xs underline">Amazon AWS</span>
            <span className="text-purple-900 font-bold text-xs underline">Photoshop</span>
            <span className="text-purple-900 font-bold text-xs underline">Web Development</span>
            <span className="text-purple-900 font-bold text-xs underline">SQL</span>
            <span className="text-purple-900 font-bold text-xs underline">Ethical Hacking</span>
            <span className="text-purple-900 font-bold text-xs underline">Graphic Design</span>
            <span className="text-purple-900 font-bold text-xs underline">Machine Learning</span>
            <span className="text-purple-900 font-bold text-xs underline">PMP</span>
            <span className="text-purple-900 font-bold text-xs underline">Cyber Security</span>
            <span className="text-purple-900 font-bold text-xs underline">Drawing</span>
          </div>
          <button className="mt-5 text-xs font-bold border border-black p-2 hover:bg-gray-200">Explore more topics</button>
        </div>
      </div>
        ...
        <div className="grid grid-cols-2 justify-center items-center mt-20 mx-20" style={{width: "90%"}}>
          <div className="pl-10">
            ...
            <ul className="list-disc ml-5 text-xl my-2">
              <li className="mt-2">Unlimited access to 26,000+ top Udemy courses, anytime, anywhere</li>
              <li className="mt-2">International course collection in 14 languages</li>
              <li className="mt-2">Top certifications in tech and business</li>
            </ul>
            <button className="bg-black text-white p-2 font-bold hover:opacity-80">Get Udemy Business</button>
            <button className="ml-2 border border-black font-bold text-black p-2 hover:bg-gray-200">Learn more</button>
          </div>
          ...
          <div className="w-full flex justify-center">
            <div className="bg-white border border-black p-10 md:w-1/3 my-10">
              <div className="text-center">
                ...
                <button className="text-purple-900 font-bold text-sm mt-4">Read full story</button>
              </div>
              <div className="flex justify-center mt-4">
                <Image src={customer} alt="customer" className="rounded-full aspect-square object-cover" width={100} height={100}/>
              </div>
      ...
      <div className="flex justify-center mx-20">
        <div className="grid grid-cols-2 justify-center items-center mt-20 mx-20" style={{width: "90%"}}>
          ...
          <div className="pl-10">
            ...
            <div className="my-2">Instructors from around the world teach millions of learners on Udemy. We provide the tools and skills to teach what you love.</div>
            <button className="bg-black text-white p-2 font-bold hover:opacity-80">Start teaching today</button>
          </div>
        </div>
      </div>
    </>
