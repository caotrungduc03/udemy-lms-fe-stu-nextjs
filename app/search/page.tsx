...
const fakeData = [
  {
    ...
    description:
      'Master by building 100 projects in 100 days. Learn data science, automation, build websites, games and apps!',
    author: 'Author',
    price: 299,
  },
  {
    ...
    <>
      <div className="grid grid-cols-12 my-5">
        ...
        <h1 className="font-bold text-2xl col-span-11">
          {numberResults} result for "{search}"
        </h1>
      </div>
              ...
              {currentData.map((course, index) => (
                ...
                >
                  <Image
                    src={course.img}
                    alt="course"
                    className="border border-gray-200 mr-5"
                  />
                  <div className="space-y-2">
                    ...
                    <button className="font-bold bg-purple-900 text-white py-2 px-5 mr-2 hover:bg-black hover:opacity-70 ">
                      Add to cart
                    </button>
                    <button className="font-bold bg-white border border-black p-2 hover:bg-gray-200">
                      Buy now
                    </button>
                  </div>
