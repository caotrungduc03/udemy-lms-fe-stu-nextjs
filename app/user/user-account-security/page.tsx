      ...
      <div className="col-span-4 border-t border-b border-r border-gray-200">
        ...
        <div className="p-5 border-t border-r border-b border-gray-200 flex flex-col items-center">
          <div className="w-full max-w-lg">
            <h1 className="font-bold text-sm border-b border-gray-200">
              Email:
            </h1>
            <div className="flex border border-black items-center rounded-md">
              <span className="ml-2">
              ...
              <MdEdit
                size={40}
                className="p-2 ml-auto border-l border-black cursor-pointer hover:bg-gray-200"
            ...
            <input
              ...
              required
              className="w-full p-2 border border-black my-2 rounded-md"
            />
            <input
