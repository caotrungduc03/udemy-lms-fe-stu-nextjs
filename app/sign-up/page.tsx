    ...
    <div className="md:grid md:grid-cols-2 md:justify-end">
      ...
      <div className="flex items-center justify-center p-5">
        <form onSubmit={handleSubmit(onSubmit)} className="bg-white p-6 rounded shadow-md w-full max-w-md">
          ...
          <button type="submit" className="bg-purple-500 text-white w-full p-2 mb-10 font-bold" disabled={isLoading}>
            {isLoading ? 'Signing up...' : 'Sign up'}
          </button>
          {error && <span className="text-red-500">Failed to sign up. Please try again.</span>}
