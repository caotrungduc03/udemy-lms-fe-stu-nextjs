...
import { useGetLessonDataQuery } from '../lib/features/lesson/lessonApi';
...
const LessonPage: React.FC<lesson> = ({ lessonId }) => {
  const { data, isLoading, isSuccess } = useGetLessonDataQuery({
    id: lessonId,
